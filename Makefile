...
# crea la instancia de rabbitmq en el namespace creado anteriormente
	kubectl apply -f ./src/rabbitmq.yaml -n angelimatias
# crea el worker
	kubectl apply -f ./src/worker.yaml -n angelimatias
# crea la api
	kubectl apply -f ./src/api.yaml -n angelimatias
...
# en caso de que se trabe el comando helm.
# helm repo update	
